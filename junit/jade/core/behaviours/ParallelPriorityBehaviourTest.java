...
public class ParallelPriorityBehaviourTest extends TestCase {
    ...
    public void testAddSubBehaviourBehaviourInt() {
        ...
        assertSame(ppb, be[0].getParent());
        assertEquals(0, ppb.getAllBehaviours().getElement(0).getStaticPriority());
        ppb.addSubBehaviour(be[1], -2);
        assertEquals(0, ppb.getAllBehaviours().getElement(1).getStaticPriority());
        ppb.addSubBehaviour(be[2], 4);
        assertEquals(4, ppb.getAllBehaviours().getElement(2).getStaticPriority());
        ppb.addSubBehaviour(be[3], 1);
        assertEquals(1, ppb.getAllBehaviours().getElement(3).getStaticPriority());
        //ppb.scheduleFirst();
        ppb.action();
        checkLists(4,0,2,0);
        be[4].block();
        ppb.addSubBehaviour(be[4], 1);
        assertEquals(1, ppb.getAllBehaviours().getElement(4).getStaticPriority());
        checkLists(5,0,2,1);
        ppb.addSubBehaviour(be[5], 10);
        assertEquals(10, ppb.getAllBehaviours().getElement(5).getStaticPriority());
        checkLists(6,0,2,1);
    ...
    public void testReset() {
        ...
        ppb.reset();
        checkLists(3, 0, 0, 0);
        assertEquals(2, ppb.getAllBehaviours().getElement(0).getDynamicPriority());
        assertEquals(2, ppb.getAllBehaviours().getElement(0).getStaticPriority());
        assertEquals(1, ppb.getAllBehaviours().getElement(1).getDynamicPriority());
        assertEquals(1, ppb.getAllBehaviours().getElement(1).getStaticPriority());
        assertEquals(0, ppb.getAllBehaviours().getElement(2).getDynamicPriority());
        assertEquals(0, ppb.getAllBehaviours().getElement(2).getStaticPriority());        
    }
    ...
    public void testScheduleFirstAny0AllBlocked() {
        ...
        ppb.addSubBehaviour(be[3], 1);
        ppb.scheduleFirst();
        assertEquals(4, ppb.getAllBehaviours().getElement(0).getDynamicPriority());
        assertEquals(1, ppb.getAllBehaviours().getElement(1).getDynamicPriority());
        assertEquals(1, ppb.getAllBehaviours().getElement(2).getDynamicPriority());
        assertEquals(1, ppb.getAllBehaviours().getElement(3).getDynamicPriority());
        checkLists(4,0,2,4);
    ...
    public void testScheduleFirstAny0Blocked() {
        ...
        ppb.addSubBehaviour(be[3], 1);
        ppb.scheduleFirst();
        assertEquals(3, ppb.getAllBehaviours().getElement(0).getDynamicPriority());
        assertEquals(2, ppb.getAllBehaviours().getElement(1).getDynamicPriority());
        assertEquals(1, ppb.getAllBehaviours().getElement(2).getDynamicPriority());
        assertEquals(1, ppb.getAllBehaviours().getElement(3).getDynamicPriority());
        checkLists(4,0,3,2);
    ...
    public void testScheduleFirstSome0Blocked() {
        ...
        assertEquals(1, ppb.getAllBehaviours().getElement(2).getDynamicPriority());
        assertEquals(1, ppb.getAllBehaviours().getElement(3).getDynamicPriority());
        assertEquals(0, ppb.getAllBehaviours().getElement(4).getDynamicPriority());
        checkLists(5, 0, 2, 2);
    ...
    public void testScheduleFirstSome0NonBlocked() {
        ...
        ppb.scheduleFirst();
        assertEquals(5, ppb.getAllBehaviours().getElement(0).getDynamicPriority());
        assertEquals(2, ppb.getAllBehaviours().getElement(1).getDynamicPriority());
        assertEquals(1, ppb.getAllBehaviours().getElement(2).getDynamicPriority());
        assertEquals(0, ppb.getAllBehaviours().getElement(3).getDynamicPriority());
        checkLists(4, 0, 1, 0);
        assertSame(be[3], ppb.getReadyBehaviours().getElement(0).getBehaviour());
        assertSame(be[3], ppb.getCurrent());
    }
    ...
    public void testScheduleNextAny0Blocked() {
        ...
        ppb.scheduleFirst();
        ppb.scheduleNext(false,1);
        assertEquals(1, ppb.getAllBehaviours().getElement(0).getDynamicPriority());
        assertEquals(2, ppb.getAllBehaviours().getElement(1).getDynamicPriority());
        assertEquals(1, ppb.getAllBehaviours().getElement(2).getDynamicPriority());
        assertEquals(1, ppb.getAllBehaviours().getElement(3).getDynamicPriority());
        checkLists(4, 0, 3, 2);
