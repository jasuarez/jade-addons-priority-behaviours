...
public class TestAgent extends Agent {
    ...
    protected void setup() {
        printExpected();
        ParallelPriorityBehaviour ppb = new ParallelPriorityBehaviour(this, ParallelPriorityBehaviour.WHEN_ALL);
    ...
    private void printExpected() {
        System.out.println("EXPECTED: 1-3-1-2-3-1-3-2-2-");
