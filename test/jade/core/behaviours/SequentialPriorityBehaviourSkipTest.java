...
/**
 * Unit tests for the <code>SequentialPriorityBehaviour</code> class, when we
 * skip the blocked behaviours.
 * 
 * @author Juan A. Suarez Romero - University of A Coruna
 * @version $Date$ $Revision$
 */
public class SequentialPriorityBehaviourSkipTest extends TestCase {
    ...
    protected void setUp() throws Exception {
        ...
        spb = new SequentialPriorityBehaviour(new AgentExample(), true);
    }
    ...
    public void testAddSubBehaviourBehaviourIntAllBlocked() {
        ...
        spb.addSubBehaviour(be[5], 0);
        spb.action();
        checkLists(6,0,1,3);
        assertTrue(spb.isRunnable());
        assertSame(spb.getCurrent(), be[5]);
    }
