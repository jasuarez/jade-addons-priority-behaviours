...
public class AllTests {
    ...
    public static Test suite() {
        TestSuite suite = new TestSuite("Test for jade.core.behaviours");
        //$JUnit-BEGIN$
        suite.addTestSuite(ParallelPriorityBehaviourTest.class);
        suite.addTestSuite(EncapsulatedPriorityBehaviourListTest.class);
        suite.addTestSuite(EncapsulatedPriorityBehaviourTest.class);
