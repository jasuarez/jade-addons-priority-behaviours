...
public class TestComposeParallelBehaviour extends ParallelBehaviour {
    ...
    public TestComposeParallelBehaviour(Agent a, int numChilds) {
    ...
    public int onEnd() {
        ...
        System.out.println("Resultado de las pruebas (ParallelBehaviour):");
