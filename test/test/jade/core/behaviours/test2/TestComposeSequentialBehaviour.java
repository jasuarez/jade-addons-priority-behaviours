...
public class TestComposeSequentialBehaviour extends SequentialBehaviour {
    ...
    public TestComposeSequentialBehaviour(Agent a, int numChilds) {
        super(a);
    ...
    public int onEnd() {
        ...
        System.out.println("Resultado de las pruebas (SequentialBehaviour):");
